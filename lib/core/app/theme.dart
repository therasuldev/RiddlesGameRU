...
class Themes {
  ...
  ThemeData get light => ThemeData(
        ...
        textTheme: TextTheme(
          headlineSmall: TextStyle(color: Colors.orange.shade900),
          bodyLarge: const TextStyle(color: Colors.black54),
          titleLarge: const TextStyle(color: Color.fromARGB(255, 41, 127, 135)),
        ),
  ...
  ThemeData get dark => ThemeData(
        ...
        textTheme: const TextTheme(
          ...
          bodyLarge: TextStyle(color: ColorName.grey),
          titleLarge: TextStyle(color: Color.fromARGB(255, 41, 127, 135)),
        ),
